...
/**
 * Class GitRepo that gives access to git commands
 *
 * @package Pub\Git
 */
class GitRepo {
     ...
     * @return  string
     */
    public function active_branch($keepAsterisk = false) {
